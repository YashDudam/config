...
# export PATH="$PATH:/Library/TeX/texbin/:/usr/local/opt/llvm/bin:/Users/yash/scripts"
export FLASK_ENV=development
export PATH="/usr/local/bin:/usr/local/opt/llvm/bin:/System/Cryptexes/App/usr/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Library/TeX/texbin:/Users/yash/.os161-toolchain/bin:/Users/yash/scripts"
alias mkcd='source mkcd'

alias connect="ssh z5419053@cse.unsw.edu.au"
alias connectdb="ssh z5419053@d2.cse.unsw.edu.au"
# export PATH="/usr/local/opt/llvm/bin:$PATH"
alias leak="ASAN_OPTIONS=detect_leaks=1"
alias check-temp="sudo powermetrics --samplers smc |grep -i \"CPU die temperature\""
alias view="fd --type f --hidden --exclude .git | fzf-tmux -p --reverse | xargs nvim"
...
alias cseumount="umount -f ${_SSHFS_CSE_MOUNT}"
